...
public class PushNotification {
    ...
    public void receivePushNotification() {
        System.out.println("Receiving a push notification about a product offer.");
    }

    @Then("Tap the notification")
    public void tapPushNotification() {
        System.out.println("Tapping the push notification to open the app.");
    }
